...
export default function Navbar() {
    return (
        <nav className="flex items-center justify-between *:text-nonPrimaryText md:px-10 sm:px-5 px-3 pt-8">
            <div className="flex items-center justify-center gap-4">
                ...
                >
                    ...
                    <p className="sm:block hidden">andremontoito@gmail.com</p>
                    <picture>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 384 512"
            ...
            <div className="flex items-center justify-center md:gap-10 gap-4 *:flex *:items-center *:justify-center *:gap-4 ">
                <div>
                    <a
